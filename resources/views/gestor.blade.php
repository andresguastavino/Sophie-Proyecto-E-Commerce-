      ...
      <div id="tabs-1">
        ...
        @forelse ($productos as $producto)
          <div class="producto row">
            ...
            <div class="col-md-2 text-center nombre">
              {{$producto->nombre}}
            </div>
            <div class="col-md-2 text-center">
              {{$producto->precio}}
            </div>
            <div class="col-md-2 text-center marca_producto">
              {{$producto->marca->nombre}}
            </div>
            <div class="col-md-2 text-center categoria_producto">
      ...
      <div id="tabs-4">
        ...
        @forelse ($users as $user)
          <div class="row user">
            ...
            <div class="col-md-3 text-center email">
              {{$user->email}}
            </div>
            <div class="col-md-1 text-center">
              {{($user->admin)?'Si':'No'}}
